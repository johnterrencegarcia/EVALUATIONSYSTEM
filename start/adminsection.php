    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                <div class="modal fade" id="addsectionModal" tabindex="-1" role="dialog" aria-labelledby="addsectionModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="../code/add_section.php" id="sectionForm">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title fw-bold fs-2 text-primary"><b>Manage Section</b></h5>
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addsectionModal">
                                            <i class="bx bxs-user-plus" style="border-radius: 100px;"></i> Add Section
                                        </button>
                                    </div>
                                </div>
                                <table class="table table-bordered table-striped table-no-border" style="margin-top: 10px; width: 100%;">
                                    <thead>
                                        <tr style="color: black; border-radius: 100px;">
                                            ...
                                            <th style="width: 20%; text-align: center;">Students</th>
                                            <th style="width: 25%; text-align: center;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="outputsection">
                                        <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="pagination justify-content-center">
                                            <?php
                                            $total_records_query = "SELECT COUNT(*) AS total_records FROM section_tbl";
                        ...
                        document.getElementById('search-Input').addEventListener('input', function() {
                            ...
                            xhr.onreadystatechange = function() {
                                if (xhr.readyState == 4 && xhr.status == 200) {
                                    ...
                                    outputsection.style.opacity = '0'; // Set opacity to 0 for smooth fade out
                                    outputsection.style.pointerEvents = 'none'; // Disable pointer events during transition

                                    setTimeout(() => {
                                        outputsection.innerHTML = xhr.responseText;
                                        outputsection.style.opacity = '1'; // Set opacity to 1 for smooth fade in
                                        outputsection.style.pointerEvents = 'auto'; // Enable pointer events after transition
                                    }, 300); // Adjust the delay as needed for smoother animation
                                }
                            };
                            xhr.open('POST', '../code/search_section.php', true);
                            xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                            xhr.send('outputSection=' + searchInputValue);
                        });
                    </script>
                        ...
                        function deleteSection(sectionId) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    // Send AJAX request to delete_section.php
                                    ...
                                    xhr.open('POST', '../code/delete_section.php', true);
                                    xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
