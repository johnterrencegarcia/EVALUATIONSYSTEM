                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="../code/add_course.php" id="courseForm">
                ...
                <div class="container-fluid">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCourseModal">
                                            <i class="bx bxs-user-plus" style="border-radius: 100px;"></i> Add Course
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="pagination justify-content-center">
                                            <?php
                                            $total_records_query = "SELECT COUNT(*) AS total_records FROM course_tbl";
                    ...
                    <script>
                        document.getElementById('search-Input').addEventListener('input', function() {
                            ...
                            xhr.open('POST', '../code/search_course.php', true);
                            xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                            xhr.send('courseName=' + searchInputValue);
                        });
                    </script>
                        ...
                        function deleteCourse(courseId) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    xhr.open('POST', '../code/delete_course.php', true);
                                    xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
