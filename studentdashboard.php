...
<head>
    ...
    <link href="./start/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" rel=" stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="./start/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    if (!isset($_SESSION['user_id']) && !isset($_SESSION['admin_role']) && $_SESSION['user_role'] !== 'Student') {
        header('location:../index.php');
        exit();
    } else {
    }
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #00008B;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="adminevaluation.php">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var overviewChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Total Users', 'Total Courses', 'Total Subjects', 'Total Sections', 'Total Faculty', 'Total Evaluations'],
            datasets: [{
                label: 'Count',
                data: [/* Dynamic Users Value */, 5, 8, 4, 18, 0],
                backgroundColor: [
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(75, 192, 192, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
